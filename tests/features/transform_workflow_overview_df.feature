Feature: Transform workflow overview DataFrame
  ...
  Scenario: Successfully transform workflow data
    Given the following workflow data:
      | repo     | workflow_name | updated_at           | status  | html_url                                         | duration_seconds | active_status |
      | frontend | build         | 2025-09-29T12:00:00Z | success | https://github.com/powellrhys/frontend/actions/1 | 125              | active        |
      | backend  | test          | 2025-07-29T12:00:00Z | failed  | https://github.com/powellrhys/backend/actions/2  | 310              | inactive      |
    ...
    And the status_flag column should correctly reflect the active_status
